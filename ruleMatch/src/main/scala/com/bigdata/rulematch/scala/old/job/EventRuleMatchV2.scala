package com.bigdata.rulematch.scala.old.job

import com.bigdata.rulematch.scala.old.bean.EventLogBean
import com.bigdata.rulematch.scala.old.function.{EventJSONToBeanFlatMapFunction, RuleMatchKeyedProcessFunctionV1, RuleMatchKeyedProcessFunctionV2}
import com.bigdata.rulematch.scala.old.source.KafkaSourceFactory
