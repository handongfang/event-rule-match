...
public class HbaseQuerier {
     ...
     * @param hbaseConn
     */
    public HbaseQuerier(Connection hbaseConn) {
     ...
     * @return
     */
    public boolean queryProfileConditionIsMatch(String rowkey, Map<String, Pair<String, String>> userProfileConditions) {
